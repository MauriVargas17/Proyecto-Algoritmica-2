        ...
        child: Column(
          ...
          children: [
            Center(
              ...
              child: Row(
                children: [
                  if(!isTheNumber && counter<4) Image.asset('assets/finnAsking.png', scale: 5.25,),
                  if(!isTheNumber && counter>=4) Image.asset('assets/finnAngry.png', scale: 5.25),
                  if(isTheNumber) Image.asset('assets/finnWinner.png', scale: 5.25),
                ],
              ),
            ),
            Divider(
            ...
            Row(
              children: [
                ...
                if(isTheNumber)  Text('I win! I am the cool guy!', style: TextStyle(
                  color: Colors.white,
                  fontSize: 15,
                  fontFamily: 'Thunderman',
                  letterSpacing: 0.5,
